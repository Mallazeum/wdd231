...
function coursePrint(courses){
    courses.forEach(function(course){
        const printElement = document.createElement('p');

        printElement.textContent = `${course.subject} ${course.number}`;
        if(course.completed){
            printElement.className = "complete";
        }
        

        classes.appendChild(printElement)
    });
    ...
    creditElement.id = 'credits';
    classes.append(creditElement);
}
